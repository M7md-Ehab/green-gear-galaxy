...
-- Policy for UPDATE: Only allow incrementing attempts counter (simplified to avoid OLD reference issues)
CREATE POLICY "Service role can update attempts only" 
ON public.password_reset_otps 
FOR UPDATE 
TO service_role
USING (

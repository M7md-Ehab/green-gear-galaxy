...
export function OtpVerificationModal({ open, onOpenChange, email, otpType = 'login', onVerificationSuccess }: OtpVerificationModalProps) {
  ...
  const handleResend = async () => {
    ...
    setResending(true);
    const { error } = await resendOtp(email, otpType);
